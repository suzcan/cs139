...
<body>
    ...
    <?php
      ...
      //list items placed
      echo "<form> <ol id='items_list'>";
      while($row = $itemResults->fetchArray()) {
	echo "
	  <li>" .$row['content']. "<input type='checkbox' class='lid' name='item".$row['numeration']."'  value='".$row['numeration']."' id='".$curUser."".$category."".$list."".$row['numeration']."' ></li>
	";
	...
	$GLOBALS['lastnumeration'] = $row['numeration'];
      ...
      echo "<table>
	    <td><form action='adderI.php' method='post' id='target'>
	    Add List Item: <input type='text' name='newItem' id='newItem'>
	    </td>
